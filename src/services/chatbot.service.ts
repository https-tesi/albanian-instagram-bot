...
import { LoggingBusinessNotificationService } from "./notification.service";
...
const handoff = new HumanHandoffService(conversations, new LoggingBusinessNotificationService(), send);
